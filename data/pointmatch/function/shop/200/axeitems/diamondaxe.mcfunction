...
execute unless score @s PM_Points matches 4.. run execute as @s at @s run playsound minecraft:block.note_block.bass
execute unless score @s PM_Points matches 4.. run return fail
