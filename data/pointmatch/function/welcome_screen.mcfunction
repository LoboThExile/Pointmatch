...
#tellraw @a ""
tellraw @a [{text:" [OTHER CREDITS]",color:green,hover_event:{action:"show_text",value:"Click here to go to the credits menu..."},bold:true,click_event:{action:"run_command",command:"trigger PM_CreditsPage set 1"}}]
