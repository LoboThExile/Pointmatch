...
tellraw @a ""
tellraw @a [{"text":"[ Open Shop ]","color":"green","bold":true,"hover_event":{"action":"show_text","value":{"text":"Click to open the shop!","color":"yellow"}},"click_event":{"action":"run_command","command":"trigger PM_Shop set -100"}},{text:"      ",hover_event:{action:"show_text",value:""},click_event:{action:"suggest_command",command:"/tell @s idk what ur trying to do by pressing the blank space but go ahead"}},{text:"[ Start Game ]", color:light_purple, bold:true, hover_event:{action:"show_text","value":"Click here to start the game.\n(ADMIN ONLY)"},click_event:{action:"show_dialog",dialog:{type:"confirmation",title:"Are you sure you want to do this?",no:{label:"Fuh naw",action:{type:"run_command",command:"trigger PM_Shop set 10"},width:700},yes:{label:"I love violence.",tooltip:"Start the game.. I guest..",width:100,action:{type:"run_command",command:"function pointmatch:game/startcountdown"}},body:{type:"plain_message",contents:" Are you sure you want to start Pointmatch? \n When You press that lil button then it will start the game. \n Yes you have to press this everytime the game/round ends. \n Yes you will be prompted this again. \n Yes you need to do it everythime. \n Goodluck.",width:900},can_close_with_escape:true}}}]
