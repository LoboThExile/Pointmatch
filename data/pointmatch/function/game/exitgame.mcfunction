...
# $execute if $(alphadied) run scoreboard players add @a[team=Alpha] PM_Points 5
# $execute if $(alphadied) run scoreboard players add @a[team=!Alpha] PM_Points 2

# $execute if $(bravodied) run scoreboard players add @a[team=Bravo] PM_Points 5
# $execute if $(bravodied) run scoreboard players add @a[team=!Bravo] PM_Points 2
...
execute if score #game PM_GameRound matches 2 as @a run schedule function pointmatch:welcome_screen_client 15s
execute if score #game PM_GameRound matches 2 run return 1
