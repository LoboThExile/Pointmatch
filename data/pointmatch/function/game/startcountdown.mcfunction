...
execute if score $total PM_Players matches ..1 as @a run tellraw @a [{text:"Bailing out, you are on your own now. Good luck.\n",color:"red"}]
...
#execute if score $total PM_Players matches ..1 as @a run tellraw @a {text:"Warning: Player count is below 2. Continuing anyway...", color:yellow}
